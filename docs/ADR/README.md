...
| [ADR-015](ADR-015-AutoEncoderStructure.md)   | Auto-Encoder Structure     | Superseded by ADR-023          |
...
| [ADR-023](ADR-023-AutoEncoderStructure.md)   | Auto-Encoder Structure     | Accepted                       |