...
| [ADR-010](ADR-010-RealData.md)               | Real Data Collection       | Accepted — In Progress |
| [ADR-011](ADR-011-FeatureSelection.md)       | Feature Selection          | Accepted               |
| [ADR-012](ADR-012-FeatureScaling.md)         | Feature Scaling            | Accepted               |
...
| [ADR-015](ADR-015-AutoEncoderStructure.md)   | Auto-Encoder Structure     | Superseded by ADR-019  |
...
| [ADR-019](ADR-019-AutoEncoderStructure.md)   | Auto-Encoder Structure     | Accepted               |   