...
def process_raw_dataset():
    ...
    df = pd.read_csv(f'{BASE_DIR}/datasets/raw/CICIDS2017/Aggregated/CICIDS2017_ae_training.csv', low_memory=False)
    extract_features_ae(df, 'training', save_type='export')

    df = pd.read_csv(f'{BASE_DIR}/datasets/raw/CICIDS2017/Aggregated/CICIDS2017_ae_testing_benign.csv', low_memory=False)
    extract_features_ae(df, 'testing_benign', save_type='export')

    df = pd.read_csv(f'{BASE_DIR}/datasets/raw/CICIDS2017/Aggregated/CICIDS2017_ae_testing_malicious.csv', low_memory=False)
    extract_features_ae(df, 'testing_malicious', save_type='export')

    df = pd.read_csv(f'{BASE_DIR}/datasets/raw/CICIDS2017/Aggregated/CICIDS2017_rf_training.csv', low_memory=False)
    extract_features_rf(df, 'training', save_type='export')

    df = pd.read_csv(f'{BASE_DIR}/datasets/raw/CICIDS2017/Aggregated/CICIDS2017_rf_testing.csv', low_memory=False)
