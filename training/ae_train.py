...
def train_model(load=False, epochs=20, features=None, batch_size=2048, update_scaler=False, save_backup=False, label='', construction=''):
    ...
    if save_backup:
        ...
        shutil.copy(artifacts/'ae_model.pt', artifacts/'manual_backups'/f'{construction}_construction'/f'ae_model_{label}.pt')
...
if __name__ == '__main__':
    train_model(load=False, epochs=150, update_scaler=True, save_backup=True, label='Initial_150_epochs_low_patience', construction='20_16_10_6')