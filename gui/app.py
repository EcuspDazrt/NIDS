...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        self.bg_image = ctk.CTkImage(light_image=Image.open("resources/Frame.png"), dark_image=Image.open("resources/Frame.png"), size=(900, 500))
        self.bg_label = ctk.CTkLabel(self.root, image=self.bg_image, text="", bg_color='#483941')
        self.bg_label.place(relx=0, rely=0, relwidth=1, relheight=1)

        self.start_anomaly_bar = ctk.CTkImage(light_image=Image.open("resources/start_anomaly_bar.png"), dark_image=Image.open("resources/start_anomaly_bar.png"), size=(22, 30))
        self.start_anomaly_bar = ctk.CTkLabel(self.bg_label, image=self.start_anomaly_bar, text="", bg_color='#483941')

        self.anomaly_bar = ctk.CTkImage(light_image=Image.open("resources/anomaly_bar.png"), dark_image=Image.open("resources/anomaly_bar.png"), size=(1, 30))
        self.anomaly_bar = ctk.CTkLabel(self.root, image=self.anomaly_bar, text="")

        self.safe_img = ctk.CTkImage(light_image=Image.open("resources/safe.png"), dark_image=Image.open("resources/safe.png"), size=(240, 160))
        self.safe_img = ctk.CTkLabel(self.bg_label, image=self.safe_img, text="", bg_color='#483941')
        self.rf_widgets.append(self.safe_img)

        self.potential_img = ctk.CTkImage(light_image=Image.open("resources/potential_threat.png"), dark_image=Image.open("resources/potential_threat.png"), size=(280, 160))
        ...
        self.likely_img = ctk.CTkImage(light_image=Image.open("resources/threat_likely.png"), dark_image=Image.open("resources/threat_likely.png"), size=(241, 160))
        ...
        self.danger_img = ctk.CTkImage(light_image=Image.open("resources/danger.png"), dark_image=Image.open("resources/danger.png"), size=(240, 160))
        ...
        for _ in range(3):
            for i in range(10):
                number_img = ctk.CTkImage(light_image=Image.open(f"resources/{i}.png"), dark_image=Image.open(f"resources/{i}.png"), size=(20, 39))
                number_img = ctk.CTkLabel(self.bg_label, image=number_img, text="", bg_color='#483941')
                self.ae_widgets.append(number_img)

        self.normal_text = ctk.CTkImage(light_image=Image.open("resources/normal.png"), dark_image=Image.open("resources/normal.png"), size=(161, 39))
        ...
        self.elevated_text = ctk.CTkImage(light_image=Image.open("resources/elevated.png"), dark_image=Image.open("resources/elevated.png"), size=(179, 39))
        ...
        self.suspicious_text = ctk.CTkImage(light_image=Image.open("resources/suspicious.png"), dark_image=Image.open("resources/suspicious.png"), size=(209, 44))
        ...
        self.severe_text = ctk.CTkImage(light_image=Image.open("resources/severe.png"), dark_image=Image.open("resources/severe.png"), size=(153, 39))
        ...
        def toggle_label():
            ...
            ae_percent, ae_score, rf_score = infer()
            self.remove_all()
    ...
    def display_ae(self, guess, score):
        ...
        self.anomaly_bar = ctk.CTkImage(light_image=Image.open(f"resources/anomaly_bar.png"), dark_image=Image.open(f"resources/anomaly_bar.png"), size=(width, 30))
